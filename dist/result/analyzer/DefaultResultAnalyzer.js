 ...
 */
export class DefaultResultAnalyzer {
    constructor(config, _masterEvent) {
        this._summary = {};
        this._lastTickTime = 0;
        this._tickSummary = {};
        this.distributeRecords = {};
        this._config = config ?? {};
        _masterEvent.once("master:command:run-test", () => {
            this._startTime = Date.now();
        });
        _masterEvent.on("master:sample-records:store", (sampleRecords) => {
            this.processRecordsToSummary(sampleRecords);
            this.processRecordsToTickSummary(sampleRecords);
        });
    }
    async init() { }
    async processRecordsToSummary(sampleRecords) {
    ...
    async processRecordsToTickSummary(sampleRecords) {
    ...
    calDistBlanketsPercentile(blankets, totalRecords, percentile) {
...
//# sourceMappingURL=DefaultResultAnalyzer.js.map